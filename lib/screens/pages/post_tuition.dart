...
import 'package:eduhome_project/screens/pages/student_notification.dart';
...
void handleDaysInWeek(String value){
             ...
             Container(
              ...
              width: 366,
               child: Expanded(
                 ...
                 style: ButtonStyle(
                         backgroundColor: MaterialStatePropertyAll<Color>(Colors.lightBlue.shade400),
  ...
  children: [
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            stops: [0.1, 0.7, 0.9], // Adjust the stops to control the boldness at the center
    ...
    Padding(
      padding: EdgeInsets.symmetric(horizontal: 16), // Add spacing between gradients and text
      child: Text(
        "Add New Post",
