...
import '../../constants/tuition_post.dart';
         ...
         Column(
          ...
          children:  fetchedPosts.map((item){
              return Padding(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: item.booked?Colors.red.shade300: Colors.greenAccent.shade100,
                    borderRadius: BorderRadius.circular(20.0),
                    border: Border.all(
                      color: item.booked?Colors.redAccent.shade700:Colors.green.shade600,
                    )
                  ),
                  ...
                  child: Column(
                    children: [
                      SizedBox(height: 3,),
                      Text("Need Tutor For Class ${item.studentClass} Student",
                      style: TextStyle(
                        fontWeight: FontWeight.w600,
                        fontSize: 21
                      ),
                      textAlign: TextAlign.center,),
                   Text("${item.daysInWeek} Days/Week",
                      style: TextStyle(
                        fontWeight: FontWeight.w600,
                        fontSize: 21
                      ),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text("Preferred Tutor: ",
                    style: TextStyle(
                      fontWeight: FontWeight.w400,
                      fontSize: 17
                    ),),
                    Text("${item.preferredGender}",
                    style: TextStyle(
                      fontWeight: FontWeight.w500,
                      fontSize: 19
                    ),)
               ...
               Row(
                ...
                children: [
                 ...
                 Container(
                  child: Row(
                    children: [
                      item.booked?SizedBox(width: 0,): IconButton(onPressed: (){
                      
                      // EDIT  BUTTON 

                }, icon: FaIcon(FontAwesomeIcons.penToSquare,
                      color: item.booked?Colors.red.shade900: Colors.greenAccent.shade700)
                 ...
                 IconButton(onPressed: (){
                  ...
                  item.booked?SizedBox(width:95,):SizedBox(width: 50,),
             ...
             Container(
               ...
               child: Expanded(
                 child:ElevatedButton(onPressed: (){}, style: ElevatedButton.styleFrom(
                      primary:item.booked? Colors.red.shade700:Colors.green, // Background color
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10.0),
                         // Rounded border
                         side:BorderSide(
                          color:item.booked?Colors.red.shade900:Colors.green.shade600,
                          width:2.0
                         ),
                    ...
                    child: Text(item.booked?"BOOKED":"APPLY",
                    style: TextStyle(
